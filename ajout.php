    ...
    <div class="container">
        ...
        <form action="addTraitement.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="titre" id="titre" placeholder="Appartement de haut standing" required>
            </div>
            <div class="form-group">
                <label for="adresse">Addresse</label>
                <input type="text" class="form-control" name="adresse" id="adresse" placeholder="12 allée des Platanes" required>
            </div>
            <div class="form-row">
